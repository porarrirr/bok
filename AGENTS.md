...
## Subagent Usage
- Use subagents proactively for complex, multi-step tasks (e.g., codebase exploration, parallel file searches, refactoring across multiple files).
- Subagent models must be **claude-opus-4.6 high** or **GPT-5.4 high** only.
- Do NOT use other models such as claude-haikku-4.5, gpt-5.4-mini, or any lower-tier models for subagents.